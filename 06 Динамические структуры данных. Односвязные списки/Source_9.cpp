...
void insert(list*& pHead, float value)
{
	list* newP = new list;
...
float del(list*& pHead, float value)
{
...
list* search(list*& pHead, float value)
{
	if (pHead == NULL)
	{
...
int main()
{
	...
	do
	{
		...
		case 7:
		{
			cout << "Среднее арифметическое: " << average(first) << endl;
			break;
		}
		}
	} while (choice != 8);
